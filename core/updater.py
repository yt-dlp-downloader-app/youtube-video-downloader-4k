...
class UpdateChecker(QObject):
    ...
    def __init__(self):
        ...
        self.github_api_url = "https://api.github.com/repos/videoextractor/YouTubeMusicDownloader/releases/latest"
        self.headers = {
            "User-Agent": f"YouTubeLabsMusicDownloader/{VERSION} ({platform.system()} {platform.release()})",
    ...
    def check_for_updates(self):
        ...
        try:
            response = requests.get(self.github_api_url, headers=self.headers, timeout=20)
